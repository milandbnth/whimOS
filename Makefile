all: boot/boot.o boot/gdt_flush.o boot/idt_flush.o boot/isr.o \
     kernel/kernel.o kernel/gdt.o kernel/idt.o
	ld -m elf_i386 -T linker.ld -o whimos.bin \
	    boot/boot.o boot/gdt_flush.o boot/idt_flush.o boot/isr.o \
	    kernel/kernel.o kernel/gdt.o kernel/idt.o
